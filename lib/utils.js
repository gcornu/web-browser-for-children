...
/**
 * Returns the  active tab of the active window
 * 
 * @return {tab} the active tab of the active window
 */
function getActiveTab() {
	...
	// return the active tab of this window
	return tabUtils.getActiveTab(topWindow);
}
