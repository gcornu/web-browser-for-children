...
exports.addCustomWhitelistCategory = addCustomWhitelistCategory;
exports.removeCustomWhitelistCategory = removeCustomWhitelistCategory;
exports.getDefaultWhitelist = getDefaultWhitelist; // test purposes only
exports.getCustomWhitelist = getCustomWhitelist; // for timeLimit
...
/**
 * Getter for the custom whitelist
 */
function getCustomWhitelist() {
	initCustomWhitelist(true);
	return ss.storage.customWhitelist;
}
...
/**
 * Add the given category to the custom whitelist
 *
 * @param {string} the category to add
 */
function addCustomWhitelistCategory(category) {
	if(!ss.storage.customWhitelist[category]) {
		ss.storage.customWhitelist[category] = [];
	} else {
...
/**
 * Remove the given category from the custom whitelist
 *
 * @param {string} name of the category to be deleted
 */
function removeCustomWhitelistCategory(category) {
	if(ss.storage.customWhitelist[category]) {
