...
function activate() {
	...
	//setting first tab to the homepage
	tabs[0].url=data.url('child-homepage.html');
	tabs.on('ready', function(){tabs[0].attach({contentScriptFile:[data.url("jquery-2.0.3.js"), data.url('child-homepage.js')]})});
