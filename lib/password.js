...
function isDefinedPassword(){
	if(ss.storage.pass!==""&&ss.storage.pass) return true;
	else return false;
}
...
//verifies given password against stored password
	...
	init(); //call init function. Should try to do this elsewhere so that it doesn't happen every time password is accessed.
