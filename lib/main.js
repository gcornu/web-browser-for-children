...
var parentUI = (function () { //set up all the necessary panels in a "parentUI" object
	...
	add_list.blacklist = panels.Panel({
		...
		contentScriptFile: [data.url("jquery-2.0.3.js"), data.url('js/bootstrap-select.min.js'), data.url("panels/addList.js")]
	});
	...
	add_list.whitelist = panels.Panel({
		...
		height: 200,
		contentURL: data.url('panels/addList.html'),
		contentScriptFile: [data.url("jquery-2.0.3.js"), data.url('js/bootstrap-select.min.js'), data.url("panels/addWhitelist.js")]
	});
