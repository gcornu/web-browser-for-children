...
/**
 * Open the "add to blacklist" dialog
 */
function openAddToBlacklistDialog() {
	var data = require('sdk/self').data,
...
/**
 * Open the "add to whitelist" dialog
 */
function openAddToWhitelistDialog() {
	var data = require('sdk/self').data,
		tabs = require('sdk/tabs');
	var win = require('sdk/window/utils').openDialog({
		features: Object.keys({
